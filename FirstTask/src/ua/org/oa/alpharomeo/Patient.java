...
public class Patient {
	...
	public static void initializeDatabase(int id) {
		...
		showPatientStatus(cardId[id], ilness[id], name[id], surname[id],
				healthInsurance[id]);
	}

	public static void showPatientStatus(int patientId, String patientIlness,
			String patientName, String patientSurname,
			boolean patientHealthInsurance) {
